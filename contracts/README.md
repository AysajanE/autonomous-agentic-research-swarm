...
| `contracts/kernel_interface.json` | Kernel-pack interface descriptor | W0 reviewed change only | task/manifest/API versions, semver policy; the program-namespaced claim ref is documentation-only and the v1 runtime remains single-program |
